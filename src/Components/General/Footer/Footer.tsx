...
function Footer() {
  return (
    <div className="footer text-center d-flex gap-3  flex-column">
      ...
      <div className=" d-flex align-self-center flex-column " style={{  maxWidth:"1100px"}}>
      <p>
      ...
      <p>
        Importante: Este sitio no tiene ninguna relación con sistemas reales de
        gestión de turnos médicos ni con ninguna entidad médica o profesional.
        Los datos de pacientes, médicos y turnos son ejemplos generados para
        ilustrar el funcionamiento de la aplicación.
      </p>
      </div>
      <LineTitle/>

      <div >
      <h5>Desarrollado por <span style={{fontStyle: "italic"}}>Sebastián Molina</span></h5>
      <h6>
          <a
